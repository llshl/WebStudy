...
public class TestBean {
	...
	public TestBean(int data1) {
		System.out.println("TestBean의 int매개변수 생성자");
		this.data1 = data1;
		this.data2 = 0.0;
		this.data3 = null;
	}
	...
	public TestBean(double data2) {
		System.out.println("TestBean의 double매개변수 생성자");
		this.data1 = 0;
		this.data2 = data2;
		this.data3 = null;
	}
	...
	public TestBean(String data3) {
		System.out.println("TestBean의 String매개변수 생성자");
		this.data1 = 0;
		this.data2 = 0.0;
		this.data3 = data3;
	}
	...
	public TestBean(int data1, double data2, String data3) {
		System.out.println("TestBean의 매개변수 3개짜리 생성자");
		this.data1 = data1;
		this.data2 = data2;
		this.data3 = data3;
	}
